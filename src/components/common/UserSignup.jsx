...
function UserSignup() {
  ...
  const submitHandler = async (data) => {
    ...
    try {
      if (action === "Sign Up") {
        formData.roleId = "67bd3f8a8717278a8401f812"; 
        
       
        // Default role assignment
        const res = await axios.post("https://bhookbuster-backend-3.onrender.com/https://bhookbuster.netlify.app/usr/addwithfile", formData);
